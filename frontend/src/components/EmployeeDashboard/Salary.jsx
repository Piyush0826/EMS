            ...
            {filteredSalaries.length > 0 ? (
              filteredSalaries.map((salary, index) => (
                <tr key={salary._id} className='border-b border-gray-100 hover:bg-gray-50'>
                  ...
                  <td className='px-8 py-4 text-sm text-gray-700'>{salary.allowances || 0}</td>
                  <td className='px-8 py-4 text-sm text-gray-700'>{salary.deductions || 0}</td>
                  <td className='px-8 py-4 text-sm font-semibold text-gray-900'>
                    {salary.netSalary || (salary.basicSalary || 0) + (salary.allowances || 0) - (salary.deductions || 0)}
                  </td>
