      ...
      <div className="mt-12 pt-8 border-t border-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-900">{employee.mobile || 'N/A'}</p>
          </div>

          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700">Address</label>
            <p className="mt-1 text-gray-900">{employee.address || 'N/A'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700">City</label>
            <p className="mt-1 text-gray-900">{employee.city || 'N/A'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700">State</label>
            <p className="mt-1 text-gray-900">{employee.state || 'N/A'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700">Zip Code</label>
            <p className="mt-1 text-gray-900">{employee.zipCode || 'N/A'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700">Country</label>
            <p className="mt-1 text-gray-900">{employee.country || 'N/A'}</p>
          </div>
        </div>
      </div>
    </div>
