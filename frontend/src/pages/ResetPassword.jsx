  ...
  return (
    <div className="flex flex-col items-center min-h-screen justify-center bg-gradient-to-br from-gray-50 via-blue-50 to-cyan-50">
      <div className="mb-8 text-center">
        ...
        <p className="font-poppins text-slate-600 text-lg">Create a new password</p>
      </div>

      <div className="w-96 bg-white rounded-2xl shadow-2xl p-8 border border-cyan-100">
        <h2 className="text-3xl font-bold font-poppins text-slate-800 mb-2">Reset Password</h2>
        <p className="text-slate-500 text-sm mb-6 font-poppins">Enter your new password below</p>
        ...
        {tokenExpired ? (
          <div className="text-center py-4">
            ...
            <Link 
              to="/forgot-password"
              className="inline-block bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200 shadow-lg hover:shadow-xl font-poppins"
            >
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-slate-700 font-poppins font-medium mb-2">New Password</label>
              <input
                type="password"
            ...
            <div className="mb-6">
              <label className="block text-slate-700 font-poppins font-medium mb-2">Confirm Password</label>
              <input
                type="password"
                className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition duration-200 bg-slate-50 font-poppins"
                placeholder="••••••••"
